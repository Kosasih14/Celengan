...
#define FIREBASE_AUTH "AIzaSyC4gqxOGLjcnZlWcHnp6BCa53MWY9kf5kU"
#define DATABASE_URL "https://celengan-7c473-default-rtdb.firebaseio.com/"

String studentId = "-OQdQrJ3RpvaTewtXxLf";
...
const long BOT_CHECK_INTERVAL = 1000;

// --- Telegram Bot Settings ---
#define BOT_TOKEN "7423742719:AAFFQy-Mnd7obXUuaUTNDY16eyAmx7q8xNE"
    ...
    if (servoMoveStartTime == 0) {
        ...
        if (canDetect && !isNoMoneyDetected()) {
            ...
            if (Red > 27 && Red < 34 && Green > 28 && Green < 34 && Blue > 26 && Blue < 31) {
                ...
                detectedType = "1k";
                moveServo(servo1kPosition);
            } else if (Red > 26 && Red < 32 && Green > 22 && Green < 28 && Blue > 17 && Blue < 21) {
                detectedAmount = 2000;
                detectedType = "2k";
                moveServo(servo2kPosition);
